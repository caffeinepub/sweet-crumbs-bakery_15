...
export class Backend implements backendInterface {
    ...
    async addDailySpecial(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addDailySpecial(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addMenuItem(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: boolean): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getDailySpecials(): Promise<Array<DailySpecial>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDailySpecials();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeDailySpecial(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeDailySpecial(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateDailySpecial(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateDailySpecial(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMenuItem(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: boolean): Promise<void> {
        if (this.processError) {
            try {
